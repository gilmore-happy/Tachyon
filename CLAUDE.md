...
⚠️ ***** CRITICAL CRITICAL CRITICAL ***** ⚠️

!!!###~~~ MANDATORY FILE CREATION/EDITING INSTRUCTIONS ~~~###!!!?

CONDUCT A REVIEW OF EVERY FILE CREATED/EDITED, FROM BOTTOM UP, TO ENSURE 100% ACCURACY!!!

PERFORM BROWSER SEARCHES ON HFT AND ARBITRAGE BOTS TO VERIFY SOLUTIONS AND PREVENT HALLUCINATIONS!!!

COMPILE PROJECT EVERY 4-5 EDITS TO CONFIRM FUNCTIONALITY AND CATCH ERRORS EARLY!!!
